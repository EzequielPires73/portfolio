            ...
            <div className="absolute top-0 left-0 w-full h-full">
                <div className="w-full max-w-7xl mx-auto h-full flex justify-between items-center">
                    <div className="h-full flex flex-col justify-center">
                        ...
                        <h1 className="text-white text-5xl font-semibold mt-2">Ezequiel Pires</h1>
                        <p className="max-w-lg text-white/80 mt-3">Olá, meu nome é Ezequiel Pires e sou um desenvolvedor front-end apaixonado por tecnologia. Com mais de <strong>3 anos de experiência</strong>. Meu objetivo é criar interfaces de usuário bonitas e funcionais. Estou sempre aberto a novas oportunidades e desafios.</p>
                        <ul className="mt-8 flex gap-4 max-w-lg flex-wrap">
                            <li>
