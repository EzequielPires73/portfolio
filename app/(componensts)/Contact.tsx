    ...
    return (
        <div className="h-fit bg-background pb-6">
            <div className="w-full max-w-7xl mx-auto px-3 xl:px-0 py-20 flex flex-col items-center">
                ...
                <h2 className="text-white text-3xl lg:text-4xl font-medium mt-2 text-center">Vamos trabalhar juntos?</h2>
                <h2 className="text-white text-3xl lg:text-4xl font-medium mt-2 text-center">Entre em contato</h2>
